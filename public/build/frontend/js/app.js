...
/***/ "./resources/frontend/js/components/frontend-footer-subscribe.js":
/*!***********************************************************************!*\
  !*** ./resources/frontend/js/components/frontend-footer-subscribe.js ***!
  \***********************************************************************/
/***/ (() => {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 10:
              ...
              errorMessage = data && data.errors && data.errors.email && data.errors.email[0] || data.message || "An error occurred.";
            ...
            case 18:
              ...
              showAlert("error", _context.t0.message || "An error occurred.");
            case 21:
              _context.prev = 21;
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.querySelectorAll('[data-check-price-card]').forEach(function (checkPriceCard) {
    var stayInput = checkPriceCard.querySelector('[data-check-price-input]');
    var checkinInput = checkPriceCard.querySelector('[data-check-price-checkin]');
    var checkoutInput = checkPriceCard.querySelector('[data-check-price-checkout]');
    var note = checkPriceCard.querySelector('[data-check-price-note]');
    var warning = checkPriceCard.querySelector('[data-check-price-warning]');
    var minStay = Number.parseInt(checkPriceCard.dataset.minStay || '0', 10);
    var nightLabel = checkPriceCard.dataset.nightLabel || 'nights';
    ...
    var initialCheckin = moment(checkinInput.value, 'YYYY-MM-DD', true);
    var initialCheckout = moment(checkoutInput.value, 'YYYY-MM-DD', true);
    var fallbackStart = tomorrow.clone();
    var fallbackEnd = tomorrow.clone().add(Math.max(minStay, 1), 'days');
    var startDate = initialCheckin.isValid() && initialCheckin.isSameOrAfter(tomorrow, 'day') ? initialCheckin : fallbackStart;
    var endDate = initialCheckout.isValid() && initialCheckout.isAfter(startDate, 'day') ? initialCheckout : fallbackEnd;
    var syncStayState = function syncStayState(start, end) {
      var duration = Math.max(end.diff(start, 'days'), 1);
      stayInput.value = "".concat(start.format('YYYY-MM-DD'), " - ").concat(end.format('YYYY-MM-DD'));
      checkinInput.value = start.format('YYYY-MM-DD');
      checkoutInput.value = end.format('YYYY-MM-DD');
      if (note) {
        note.textContent = "".concat(start.format('YYYY-MM-DD'), " - ").concat(end.format('YYYY-MM-DD'), " | ").concat(duration, " ").concat(nightLabel);
      }
      if (warning) {
        var shouldWarn = minStay > 0 && duration < minStay;
    ...
    $(stayInput).on('show.daterangepicker', function () {
      var picker = $(stayInput).data('daterangepicker');
      if (picker) {
    ...
    stayInput.addEventListener('click', function () {
      var _$$data;
      (_$$data = $(stayInput).data('daterangepicker')) === null || _$$data === void 0 ? void 0 : _$$data.show();
    });
  });
});
...
/***/ "./resources/frontend/js/components/frontend-loop-swiper.js":
/*!******************************************************************!*\
  !*** ./resources/frontend/js/components/frontend-loop-swiper.js ***!
  \******************************************************************/
/***/ (() => {
...
__webpack_require__(/*! ./components/frontend-footer-subscribe */ "./resources/frontend/js/components/frontend-footer-subscribe.js");
__webpack_require__(/*! ./components/frontend-pickers */ "./resources/frontend/js/components/frontend-pickers.js");
__webpack_require__(/*! ./components/frontend-hotel-check-price */ "./resources/frontend/js/components/frontend-hotel-check-price.js");
__webpack_require__(/*! ./components/frontend-loop-swiper */ "./resources/frontend/js/components/frontend-loop-swiper.js");
})();
