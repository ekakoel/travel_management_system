...
(function () {
  ...
  var createFormSubmissionGuard = (__webpack_require__(/*! ../../components/form-submission-guard */ "./resources/frontend/js/components/form-submission-guard.js").createFormSubmissionGuard);
  ...
  function formatCountdown(distance) {
    ...
    return countdownRemainingTemplate.replace(':days', String(days)).replace(':hours', String(hours)).replace(':minutes', String(minutes));
  }
    ...
    document.querySelectorAll('[data-payment-confirmation-form], form[data-confirm-message]').forEach(function (form) {
      ...
      form.addEventListener('submit', function (event) {
        ...
        submitButtons.forEach(function (button) {
          ...
          button.innerHTML = '<span class="frontend-action-spinner" aria-hidden="true"></span><span>' + (button.getAttribute('data-processing-label') || 'Processing...') + '</span>';
        });
      });
