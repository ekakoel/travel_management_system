...
return [
    ...
    'Choose check-in and check-out dates below to see live accommodation pricing.' => 'Choose check-in and check-out dates below to see live accommodation pricing.',
    'Accommodation Detail' => 'Accommodation Detail',
    'Review hotel highlights, room collection, and partner-ready hotel information before continuing to the dedicated accommodation check price flow.' => 'Review hotel highlights, room collection, and partner-ready hotel information before continuing to the dedicated accommodation check price flow.',
    'collections' => 'collections',
    'Property Overview' => 'Property Overview',
    'Partner-ready accommodation profile' => 'Partner-ready accommodation profile',
    ...
    'Property description is not available yet.' => 'Property description is not available yet.',
    ...
    'Continue to the dedicated accommodation check price page to view contract pricing, active promotions, and matching packages for your selected stay dates.' => 'Continue to the dedicated accommodation check price page to view contract pricing, active promotions, and matching packages for your selected stay dates.',
    'Login to continue to live accommodation pricing.' => 'Login to continue to live accommodation pricing.',
    'Verify your email to continue to live accommodation pricing.' => 'Verify your email to continue to live accommodation pricing.',
    'Complete your profile to continue to live accommodation pricing.' => 'Complete your profile to continue to live accommodation pricing.',
    'Your account approval is still pending. Open your profile to continue the approval flow before checking live accommodation pricing.' => 'Your account approval is still pending. Open your profile to continue the approval flow before checking live accommodation pricing.',
    'Login to Check Price' => 'Login to Check Price',
    'Verify Email' => 'Verify Email',
    'Complete Profile' => 'Complete Profile',
    'Live accommodation pricing for partner agents, calculated from standard contract rates, hotel promotions, and active packages based on the dates selected by the user.' => 'Live accommodation pricing for partner agents, calculated from standard contract rates, hotel promotions, and active packages based on the dates selected by the user.',
    'Stay' => 'Stay',
    'Dates' => 'Dates',
    'Selected Stay' => 'Selected Stay',
    'Choose dates and compare available room rates' => 'Choose dates and compare available room rates',
    'Partner-facing accommodation pricing from contract rates, promotions, and packages for the selected stay window.' => 'Partner-facing accommodation pricing from contract rates, promotions, and packages for the selected stay window.',
    'This page shows accommodation rates pulled from hotel contract prices, hotel promotions, and hotel packages based on the stay dates you selected.' => 'This page shows accommodation rates pulled from hotel contract prices, hotel promotions, and hotel packages based on the stay dates you selected.',
    'options' => 'options',
    ...
    'Bundled accommodation packages matching your stay' => 'Bundled accommodation packages matching your stay',
    'Standard contract rates across your selected dates' => 'Standard contract rates across your selected dates',
    'Airport Distance' => 'Airport Distance',
    'Airport Duration' => 'Airport Duration',
    'Km' => 'Km',
    ...
    'Confirm the contract rate selection and complete guest, transfer, and booking information before sending the hotel request.' => 'Confirm the contract rate selection and complete guest, transfer, and booking information before sending the hotel request.',
    'Selected from standard accommodation pricing for the chosen stay dates.' => 'Selected from standard accommodation pricing for the chosen stay dates.',
    ...
    'Continue with the selected accommodation package and complete the booking request with traveller details, transfers, and remarks.' => 'Continue with the selected accommodation package and complete the booking request with traveller details, transfers, and remarks.',
    ...
    'Continue to the dedicated hotel check price flow to review contract rates, active promotions, and matching packages based on your stay dates.' => 'Continue to the dedicated hotel check price flow to review contract rates, active promotions, and matching packages based on your stay dates.',
