document.addEventListener('DOMContentLoaded', function () {
    ...
    function buildPrintDocument(sheetHtml) {
        return '<!doctype html><html><head><meta charset="utf-8">' +
            ...
            '.tour-review-print-header div:last-child strong{color:#047857;display:block;font-size:32px;line-height:1;}' +
            '.tour-review-print-meta{border-bottom:1px solid #d1d5db;display:grid;gap:10px;grid-template-columns:repeat(5,minmax(0,1fr));margin:9px 0 0;padding:0 0 9px;}' +
            '.tour-review-print-meta div,.tour-review-print-team dl div{min-width:0;}' +
            '.tour-review-print-meta dd,.tour-review-print-team dd{color:#111827;font-size:12px;font-weight:800;margin:2px 0 0;overflow-wrap:anywhere;}' +
            '.tour-review-print-section{border-bottom:1px solid #d1d5db;padding:10px 0;}' +
            ...
            '.tour-review-print-notes{display:grid;gap:7px;}' +
            '.tour-review-print-notes article{border-top:1px solid #e5e7eb;padding-top:7px;}' +
            '.tour-review-print-notes article:first-child{border-top:0;padding-top:0;}' +
            '.tour-review-print-notes strong{color:#111827;display:block;font-size:12px;margin-bottom:3px;}' +
            '.tour-review-print-notes p{color:#374151;font-size:11px;line-height:1.35;margin:0;}' +
