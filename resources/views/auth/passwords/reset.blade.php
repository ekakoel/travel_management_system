        ...
        <div class="col-md-8 m-t-56">
            <div class="card-box my-5">
                ...
                <form id="reset-password" method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="form-group">
                        <label for="password" class="col-md-4 col-form-label text-md-right flex-end">{{ __('Password') }}</label>
                    ...
                    <div class="form-group m-b-18">
                        <label for="password-confirm" class="col-md-4 col-form-label text-md-right flex-end">{{ __('Confirm Password') }}</label>
                        <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password">
                    </div>
                </form>
                <div class="card-box-footer text-center">
                    <button type="submit" form="reset-password" class="btn btn-primary">
                        {{ __('Reset Password') }}
                    </button>
                </div>
            </div>
