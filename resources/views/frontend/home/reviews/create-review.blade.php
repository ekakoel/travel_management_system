...
@extends('frontend.home.reviews.layouts.app')
@section('meta')
                    ...
                    <form method="POST" action="{{ route('reviews.store') }}">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <label class="form-label required-label">@lang('messages.Guide Name')</label>
                                <input type="text" class="form-control" name="guide_name" placeholder="{{ __('messages.Insert guide name') }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <label class="form-label required-label">@lang('messages.Driver Name')</label>
                                <input type="text" class="form-control" name="driver_name" placeholder="{{ __('messages.Insert driver name') }}" required>
                                <div style="height: 18px !important;"></div>
                                <fieldset>
