...
@section('content')
    @php
        $isProfileIncomplete = Auth::user()->email == '';
        ...
        $visibleSummaryCards = collect($summaryCards)
            ->filter(fn ($summaryCard) => (int) $summaryCard['value'] > 0)
            ->values();
            ...
            <div class="container">
                ...
                @if ($isProfileIncomplete)
                    <div class="orders-notice orders-notice--warning">
                        <div>
                            ...
                            <p>@lang('messages.Please add your email first to be able to submit orders, by clicking this link')</p>
                        </div>
                ...
                @if ($allCardsCount > 0)
                    <div class="orders-summary-grid">
                        @foreach ($visibleSummaryCards as $summaryCard)
                    ...
                    <div class="orders-toolbar">
                        ...
                        <div class="orders-toolbar__filters">
                            ...
                            @foreach ($visibleSections as $section)
                                <button type="button" class="orders-filter-chip" data-order-filter="{{ $section['scope'] }}">{{ $section['title'] }}</button>
                            @endforeach
                        </div>
                    </div>
                @endif
