                            ...
                            <div class="row">
                                ...
                                @if ($wedding->include)
                                    <div class="col-12 m-b-8">
                                        ...
                                        {{-- WEDDING VENUE --}}
                                        @include('frontend.home.orders.weddings.partials.order_wedding_fixed_service')
                                    </div>
                                @endif
                                ...
                                <div class="col-md-12 m-b-18">
                                    ...
                                    <div class="card-box-content">
                                        @include('frontend.home.orders.weddings.partials.order_wedding_venues')
                                    </div>
                                    ...
                                    <div class="card-box-content">
                                        @include('frontend.home.orders.weddings.partials.order_wedding_room')
                                    </div>
                                    {{-- WEDDING DECORATION --}}
                                    <div class="subtitle-card">
                                    ...
                                    <div class="card-box-content">
                                        @include('frontend.home.orders.weddings.partials.order_wedding_decoration')
                                    </div>
                                    ...
                                    <div class="card-box-content">
                                        @include('frontend.home.orders.weddings.partials.order_wedding_dinner_venue')
                                    </div>
                                    {{-- WEDDING MAKEUP --}}
                                    <div class="subtitle-card">
                                    ...
                                    <div class="card-box-content">
                                        @include('frontend.home.orders.weddings.partials.order_wedding_makeup')
                                    </div>
                                    ...
                                    <div class="card-box-content">
                                        @include('frontend.home.orders.weddings.partials.order_wedding_entertainment')
                                    </div>
                                    ...
                                    <div class="card-box-content">
                                        @include('frontend.home.orders.weddings.partials.order_wedding_documentation')
                                    </div>
                                    {{-- WEDDING TRANSPORT --}}
                                    <div class="subtitle-card">
                                    ...
                                    <div class="card-box-content">
                                        @include('frontend.home.orders.weddings.partials.order_wedding_transport')
                                    </div>
                                    {{-- WEDDING OTHER --}}
                                    <div class="subtitle-card">
                                    ...
                                    <div class="card-box-content">
                                        @include('frontend.home.orders.weddings.partials.order_wedding_other')
                                    </div>
                                </div>
                                <div class="col-md-12">
