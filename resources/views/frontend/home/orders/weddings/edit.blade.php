            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="card-box">
                        ...
                        <div class="row">
                            @include('frontend.home.orders.weddings.sections.bride')
                            @include('frontend.home.orders.weddings.sections.flight')
                            @include('frontend.home.orders.weddings.sections.invitations')
                            @include('frontend.home.orders.weddings.sections.wedding-detail')
                            @include('frontend.home.orders.weddings.sections.wedding-venue')
                            {{-- @include('frontend.home.orders.weddings.sections.suite-and-villa-brides')
                            @include('frontend.home.orders.weddings.sections.suite-and-villa-invitations') --}}
                            @if ($orderWedding->service == "Ceremony Venue" || $orderWedding->service == "Wedding Package")
                                @include('frontend.home.orders.weddings.sections.ceremony-and-decoration-venue')
                            @endif
                            @if ($orderWedding->service == "Reception Venue" || $orderWedding->service == "Wedding Package")
                                @include('frontend.home.orders.weddings.sections.reception-and-decoration-venue')
                            @endif
                            {{-- @include('frontend.home.orders.weddings.sections.wedding-lunch-venue')
                            @include('frontend.home.orders.weddings.sections.wedding-dinner-venue') --}}
                            
                            @include('frontend.home.orders.weddings.sections.include-services')
                            @include('frontend.home.orders.weddings.sections.accommodation')
                            @include('frontend.home.orders.weddings.sections.transports')
                            @if ($orderWedding->service == "Wedding Package")
                                @include('frontend.home.orders.weddings.sections.additional-services')
                            @endif
                            {{-- REMARK --}}
