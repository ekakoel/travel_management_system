                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="card-box">
                                            ...
                                            <form id="invalidpayment-confirm-{{ $order->id }}" action="{{ route('upload.payment-confirmation', ['id' => $order->id]) }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row text-left">
                                                    <div class="col-md-12">
                                                        <div class="row">
...
@endif
@if (false && ($order->status == "Approved" or $order->status == "Paid"))
    <div class="col-md-4 desktop">
        <div class="card-box">
            <div class="card-box-title">
                <div class="subtitle"><i class="icon-copy fa fa-money" aria-hidden="true"></i> @lang('messages.Payment Status')</div>
