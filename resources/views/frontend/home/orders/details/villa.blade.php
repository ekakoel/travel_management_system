                    ...
                    <div class="card-box">
                        ...
                        <div class="card-box-footer">
                            ...
                            @if ($invoice && $order->status != "Paid")
                                <button type="button" class="btn btn-primary mobile" data-toggle="modal" data-target="#payment-confirmation-{{ $order->id }}">
                            ...
                            @elseif($order->status == "Paid")
                                @if (File::exists("storage/document/invoice-".$inv_no."-".$order->id."_en.pdf"))
                                    <a href="#" data-toggle="modal" data-target="#contract-en-{{ $order->id }}">
                                        <button type="button" class="btn btn-primary mobile"><i class="icon-copy fa fa-file-pdf-o" aria-hidden="true"></i> Invoice EN</button>
                                    </a>
                                ...
                                @if (File::exists("storage/document/invoice-".$inv_no."-".$order->id."_zh.pdf"))
                                    <a href="#" data-toggle="modal" data-target="#contract-zh-{{ $order->id }}">
                                        <button type="button" class="btn btn-primary mobile"><i class="icon-copy fa fa-file-pdf-o" aria-hidden="true"></i> Invoice ZH</button>
                                    </a>
                            ...
                            <div class="form-group">
                                <a href="/orders#orderHotel">
                                    <button type="button" class="btn btn-danger mobile" data-dismiss="modal"><i class="icon-copy fa fa-close" aria-hidden="true"></i> @lang('messages.Close')</button>
                                </a>
                            </div>
