                        ...
                        <div class="col-xl-12 mb-30">
                            <div class="card-box">
                                <div class="notification-box">
                                    ...
                                    Please add your email first to be able to submit orders by clicking this link -> <a href="/profile">Edit Profile</a></i>
                                </div>
                            </div>
                        </div>
                    @else
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="card-box">
                                    ...
                                    @endif
                                    @php
                                        $orderTourPackageHighlights = trim((string) ($order->destinations ?: ($tour->$langPackageHighlights ?: $tour->package_highlights)));
                                    @endphp
                                    @if ($orderTourPackageHighlights != "")
                                        <div class="page-subtitle">@lang('tour-detail.package_highlights')</div>
                                        <div class="page-text">
                                            {!! $orderTourPackageHighlights !!}
                                        </div>
                                    @endif
                                    @if ($tour->include != "")
                                    ...
                                    @endif
                                    @php
                                        $orderTourCancellationPolicy = $tour->$langCancellationPolicy ?: $tour->cancellation_policy;
                                    @endphp
                                    @if ($orderTourCancellationPolicy != "")
                                        <div class="page-subtitle">@lang('messages.Cancellation Policy')</div>
                                        <div class="page-text">
                                            <p>{!! $orderTourCancellationPolicy !!}</p>
                                        </div>
                                    @endif
                                    {{-- PRICES ======================================================================================================================================== --}}
                                        ...
                                        <div class="col-md-12 ">
                                            <div class="notif-modal text-left">
                                                @if ($order->status == "Draft")
                                                    @if (Auth::user()->email == "")
                                                        @lang('messages.Please add your email first to be able to submit orders, by clicking this link') -> <a href="/profile">@lang('messages.Edit Profile')</a>
                                                    @else
