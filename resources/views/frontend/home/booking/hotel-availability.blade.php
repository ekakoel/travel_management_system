            ...
            <div class="container py-4">
                ...
                <div class="frontend-page-intro">
                    <div class="frontend-page-intro__copy">
                        <h1 class="frontend-page-intro__title">@lang('messages.Choose dates and compare available room rates')</h1>
                        <p class="frontend-page-intro__text">
                            @lang('messages.Live accommodation pricing for partner agents, calculated from standard rates, hotel promotions, and active packages based on the dates selected by the user.')
                        </p>
                    </div>
                ...
                <section class="availability-hero availability-hero--merged">
                    ...
                    <div class="availability-hero__content">
                        ...
                        <h2 class="availability-title">{{ $hotel->name }}</h2>
                        <p class="availability-subtitle">
                            @lang('messages.Partner facing accommodation pricing from standard rates, promotions, and packages for the selected stay window.')
                        </p>

                        <p class="availability-description">
                            @lang('messages.This page shows accommodation rates pulled from hotel standard prices, hotel promotions, and hotel packages based on the stay dates you selected.')
                        </p>
                    </div>
                </section>
            </div>
