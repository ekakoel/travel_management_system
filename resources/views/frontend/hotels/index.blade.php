        ...
        <section id="hotels">
            ...
            <div class="heading-page-hotels">
                <div class="heading-page-content">
                    <h1>@lang('messages.Hotels') - @lang('messages.Resorts') - @lang('messages.Villas')</h1>
                </div>
            </div>
            <div class="content-container">
                <div class="pd-ltr-20">
                    <div class="row">
                        ...
                        <div class="col-md-12 py-3">
                            <div class="card-grid-container" id="hotel-list">
                                @include('frontend.partials.hotel-list', ['hotels' => $hotels])
                            </div>
                            <div class="text-center mt-9" id="load-more-container">
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#search-form').on('submit', function(e) {
                    e.preventDefault();
                    $('#hotel-list').html('<p class="text-center">Loading...</p>');
                ...
                function loadHotels(page, isSearch = false) {
                    ...
                    $.ajax({
                        url: "{{ route('frontend.hotels.load-more') }}?page=" + page,
                        type: "GET",
                        data: formData,
                        beforeSend: function() {
                        ...
                        success: function(response) {
                            ...
                            if (isSearch) {
                                $('#hotel-list').html('');
                                $('#load-more').data('page', 2); // reset ke page 2
                            }

                            // Tambahkan hasil baru di bawah yang sudah ada
                            let newContent = $(response.html);
                            $('#hotel-list').append(newContent.hide().fadeIn(300));
                        ...
                        error: function(xhr) {
                            ...
                            $('#load-more').text("@lang('messages.Load More')").prop('disabled', false);
                        }
                    });
                }
