            ...
            <div class="container">
                <div class="order-detail-layout">
                    <div class="order-detail-stack">
                        ...
                        @include('order.partials.hotel-detail-modern-addons')
                        @include('order.partials.hotel-detail-modern-price')
                    </div>

                    @include('order.partials.hotel-detail-modern-sidebar')
                </div>
            </div>
        </main>
    </div>

    @include('order.partials.hotel-detail-modern-modals')
@endsection
