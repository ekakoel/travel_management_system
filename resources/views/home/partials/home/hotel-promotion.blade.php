...
<!--            <p class="text-primary fs-5 mb-5">@lang('messages.Unlock Special Hotel Offers and Maximize Your Profit with Bali Kami Tour.')</p>-->
<!--            <p class="text-primary fs-5 mb-5">@lang('messages.As a partner of Bali Kami Tour, you gain access to exclusive hotel promotions and special rates on luxury accommodations. Enjoy discounted pricing at top-tier five-star hotels and exclusive villas, all available directly through our easy-to-use platform. Offer your clients unbeatable deals while increasing your business opportunities with our trusted system.')</p>-->
<!--        </div>-->
...
<!--                    <h5>{{ $promo->hotels ? $promo->hotels->name : __('Unknown Hotel') }}</h5>-->
<!--                    </a>-->
<!--                    <p>{{ __('messages.'.$promo->promotion_type) }}</p>-->
<!--                    <span>{{ dateFormat($promo->periode_start) }} - {{ dateFormat($promo->periode_end) }}</span>-->
<!--                </div>-->
<!--            @empty-->
