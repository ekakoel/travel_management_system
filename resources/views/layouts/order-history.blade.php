        ...
        <table id="tbVillaOrd" class="data-table table m-b-30">
            <thead>
                <tr>
                    ...
                    <th style="width: 30%;">@lang('messages.Check-in') - @lang('messages.Check-out')</th>
                    <th style="width: 15%;">@lang('messages.Price')</th>
                    <th style="width: 10%;">@lang('messages.Status')</th>
                    <th style="width: 15%;">@lang('messages.Action')</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($orderhistories as $no => $order_history)
                    ...
                    <tr style="background-color: {{ $order_history->status == 'Rejected' ? '#ffd4d4':"none" }};">
                        ...
                        <td>
                            @if (isset($statusMap[$order_history->status]))
                                <div class="{{ $statusMap[$order_history->status]['class'] }} inline-left">
                                    {!! $statusMap[$order_history->status]['label'] !!}
                                </div>
                            @endif
                        </td>
                        <td class="text-right">
                            ...
                            <div class="modal-content text-left">
                                ...
                                <div class="card-content">
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="status-order-container">
                                                        ...
                                                        <div class="status-order text-align-right">
                                                            @if (isset($statusMap[$order_history->status]))
                                                                <div class="{{ $statusMap[$order_history->status]['class'] }}">
                                                                    {!! $statusMap[$order_history->status]['label'] !!}
                                                                </div>
                                                            @endif
                                                        </div>
                                        ...
                                        @endif
                                        @if ($order_history->airport_shuttles)
                                            <div class="col-md-12">
                                                <div id="optional_service" class="page-subtitle">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-6 col-md-6">
                                                                        ...
                                                                        @if ($order_history->kick_back > 0 || $order_history->discounts > 0 || $order_history->promotion_disc > 0 || $order_history->bookingcode_disc > 0)
                                                                            ...
                                                                            <hr class="form-hr">
                                                                        @endif
                                                                        @if ($order_history->reservations->invoice)
                                                                            @if ($order_history->reservations->invoice->currency_id == 1)
                                                                                <div class="price-name">@lang('messages.Total Price') USD</div>
                                                                            @elseif ($order_history->reservations->invoice->currency_id == 2)
                                                                                <div class="normal-text">@lang('messages.Total Price') USD</div>
                                                                                <div class="price-name">@lang('messages.Total Price') CNY</div>
                                                                            @elseif ($order_history->reservations->invoice->currency_id == 3)
                                                                                <div class="normal-text">@lang('messages.Total Price') USD</div>
