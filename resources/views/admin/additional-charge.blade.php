                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="backend-form-field">
                                                                        ...
                                                                        <input name="name" id="name" wire:model="name" class="backend-form-control @error('name') is-invalid @enderror" placeholder="Select Date and Time" type="text" value="{{ $additional_charge->name }}" required>
                                                                        @error('name')
                                                                            <span class="invalid-feedback">
                                                                                <strong>{{ $message }}</strong>
                                                                            </span>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="backend-form-field">
                                                                        ...
                                                                        <div class="btn-icon">
                                                                            ...
                                                                            <input readonly type="text" id="mandatory_start" name="mandatory_start" class="input-icon backend-form-control date-picker @error('mandatory_start') is-invalid @enderror" placeholder="Select date" value="{{ $additional_charge->mandatory_start? date('d F Y',strtotime($additional_charge->mandatory_start)):'' }}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="backend-form-field">
                                                                        ...
                                                                        <div class="btn-icon">
                                                                            <span><i class="icon-copy dw dw-calendar1"></i></span>
                                                                            <input readonly type="text" id="mandatory_end" name="mandatory_end" class="input-icon backend-form-control date-picker @error('mandatory_end') is-invalid @enderror" placeholder="Select date" value="{{ $additional_charge->mandatory_end? date('d F Y',strtotime($additional_charge->mandatory_end)):'' }}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="backend-form-field">
                                                                        ...
                                                                        <div class="btn-icon">
                                                                            <span>Rp</span>
                                                                            <input type="number" id="contract_rate" name="contract_rate" class="input-icon backend-form-control @error('contract_rate') is-invalid @enderror" placeholder="Insert Markup" value="{{ $additional_charge->contract_rate }}" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="backend-form-field">
                                                                        ...
                                                                        <div class="btn-icon">
                                                                            <span>$</span>
                                                                            <input type="number" id="markup" name="markup" class="input-icon backend-form-control @error('markup') is-invalid @enderror" placeholder="Insert Markup" value="{{ $additional_charge->markup }}" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12">
                                                                    <div class="backend-form-field">
                                                                        ...
                                                                        <textarea data-backend-richtext="true" name="description" class="textarea_editor backend-form-control @error('description') is-invalid @enderror" placeholder="Select Date and Time" type="text" required>{!! $additional_charge->description !!}</textarea>
                                                                        @error('description')
                                                                            <span class="invalid-feedback">
                                                                                <strong>{{ $message }}</strong>
                                                                            </span>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="card-box">
                                ...
                                <div class="card-box-body">
                                    <form id="add-additional-charge" action="{{ route('admin.hotels.additional-charges.store') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="backend-form-field">
                                                            ...
                                                            <div class="btn-icon">
                                                                <span><i class="icon-copy dw dw-calendar1"></i></span>
                                                                <input readonly type="text" id="mandatory_start" name="mandatory_start" class="input-icon backend-form-control date-picker @error('mandatory_start') is-invalid @enderror" placeholder="Select date" value="{{ old('mandatory_start') }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="backend-form-field">
                                                            ...
                                                            <div class="btn-icon">
                                                                <span><i class="icon-copy dw dw-calendar1"></i></span>
                                                                <input readonly type="text" id="mandatory_end" name="mandatory_end" class="input-icon backend-form-control date-picker @error('mandatory_end') is-invalid @enderror" placeholder="Select date" value="{{ old('mandatory_end') }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                ...
                                <div class="card-box-footer">
                                    <button type="submit" form="add-additional-charge" class="backend-button backend-button-primary"><i class="icon-copy fa fa-plus" aria-hidden="true"></i> Add</button>
                                    <button type="button" class="backend-button backend-button-danger" data-dismiss="modal"><i class="icon-copy fa fa-close" aria-hidden="true"></i> Cancel</button>
                                </div>
                            </div>
                        </div>
