...
@section('content')
    ...
    <div class="container">
<x-backend.page-hero :title="__('messages.Agent Request Registration')" />
        ...
        <a href="{{ route('admin.agents.index') }}" class="backend-button backend-button-secondary mt-3">Back to List</a>
    </div>
@endsection
