...
@section('content')
    ...
    <div class="main-container">
        <div class="pd-ltr-20">
<x-backend.page-hero :title="__('messages.Validate Agent')" />
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="card-box">
                            ...
                            <div class="card-body">
                                ...
                                @if($agent->status != 'verified')
                                    <form action="{{ route('admin.agents.verify', $agent->id) }}" method="POST" class="mt-3">
                                        @csrf
                                        @method('PATCH')
                                        <button type="submit" class="backend-button backend-button-primary">Verify Agent</button>
                                    </form>
                                @else
                        ...
                        <a href="{{ route('admin.notifications.index') }}" class="backend-button backend-button-secondary mt-3">Back to Notifications</a>
                    </div>
                </div>
            </div>
        </div>
