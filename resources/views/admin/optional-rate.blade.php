                                        ...
                                        <div class="modal-content">
                                            <div class="card-box">
                                                ...
                                                <div class="card-box-footer">
                                                    <button type="submit" form="edit-optional-rate-{{ $optionalrate->id }}" class="backend-button backend-button-primary"><i class="icon-copy fa fa-pencil-alt" aria-hidden="true"></i> Update</button>
