                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input required type="text" name="title" id="title" wire:model="title" class="form-control  @error('title') is-invalid @enderror" placeholder="Insert Title" value="Don't miss out on our exciting promo, book now and enjoy special offers!">
                                    @error('title')
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input required type="text" name="title_mandarin" id="title_mandarin" wire:model="title_mandarin" class="form-control  @error('title_mandarin') is-invalid @enderror" placeholder="Insert Title" value="別錯過我們精彩的優惠活動，立即預訂，尊享專屬優惠！">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea required name="emails" id="emails" rows="5" style="width: 100%;" class="form-control" placeholder="ex: email_01@email.com, email_02@email.com, email_03@email.com"></textarea>
                                    @error('title')
                                        <span class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea required id="suggestion_mandarin" name="suggestion_mandarin"  class="textarea_editor form-control border-radius-0 @error('suggestion_mandarin') is-invalid @enderror" placeholder="Insert some text ...">把握限時專屬優惠，為您精心打造極致舒適、超值體驗與難忘回憶！</textarea>
