                            ...
                            @endif
                                <div class="row">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="backend-form-field">
                                                                            ...
                                                                            <input type="number" min="1" max="{{ $order->number_of_guests }}" name="number_of_guest[]" class="backend-form-control m-0 @error('number_of_guest[]') is-invalid @enderror" placeholder="Max {{ $order->number_of_guests }}" value="{{ $oro_nog[$i] }}" required>
                                    ...
                                    <div class="col-md-12 text-right">
                                        ...
                                        <button type="submit" class="backend-button backend-button-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button>
