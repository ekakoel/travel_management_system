            ...
            @if (count($prices) > 0)
                <div class="input-container">
                    <div class="input-group">
                        ...
                        <input id="searchPriceByYears" type="text" onkeyup="searchPriceByYears()" class="backend-form-control" name="search-byyear" placeholder="Filter by year">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="backend-form-field">
                                                                                ...
                                                                                <div class="btn-icon">
                                                                                    ...
                                                                                    <input readonly type="text" id="start_date" name="start_date" class="input-icon date-picker backend-form-control @error('start_date') is-invalid @enderror" placeholder="Insert Markup" value="{{ date('d F Y', strtotime($price->start_date)) }}" required>
                                                                                    @error('start_date')
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="backend-form-field">
                                                                                ...
                                                                                <div class="btn-icon">
                                                                                    <span><i class="icon-copy dw dw-calendar1"></i></span>
                                                                                    <input readonly type="text" id="end_date" name="end_date" class="input-icon date-picker backend-form-control @error('end_date') is-invalid @enderror" placeholder="Insert Markup" value="{{ date('d F Y', strtotime($price->end_date)) }}" required>
                                                                                    @error('end_date')
                                                                                        <span class="invalid-feedback">
                                                                                            <strong>{{ $message }}</strong>
                                                                                        </span>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="backend-form-field">
                                                                                ...
                                                                                <div class="btn-icon">
                                                                                    <span>Rp</span>
                                                                                    <input type="number" id="contract_rate" name="contract_rate" class="input-icon backend-form-control @error('contract_rate') is-invalid @enderror" placeholder="Insert Markup" value="{{ $price->contract_rate }}" required>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="backend-form-field">
                                                                                ...
                                                                                <div class="btn-icon">
                                                                                    <span>$</span>
                                                                                    <input type="number" id="markup" name="markup" class="input-icon backend-form-control @error('markup') is-invalid @enderror" placeholder="Insert Markup" value="{{ $price->markup }}">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="backend-form-field">
                                                                                ...
                                                                                <div class="btn-icon">
                                                                                    <span>$</span>
                                                                                    <input type="number" id="kick_back" name="kick_back" class="input-icon backend-form-control @error('kick_back') is-invalid @enderror" placeholder="Insert kick back" value="{{ $price->kick_back }}">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                         <div class="col-md-12">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="backend-form-field">
                                                                                        ...
                                                                                        <textarea data-backend-richtext="true" name="benefits" id="benefits" class="textarea_editor backend-form-control @error('benefits') is-invalid @enderror" placeholder="Insert some text" type="text">{!! $price->benefits !!}</textarea>
                                                                                        @error('benefits')
                                                                                            <span class="invalid-feedback">
                                                                                                <strong>{{ $message }}</strong>
                                                                                            </span>
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="backend-form-field">
                                                                                        ...
                                                                                        <textarea data-backend-richtext="true" name="benefits_traditional" id="benefits_traditional" class="textarea_editor backend-form-control @error('benefits_traditional') is-invalid @enderror" placeholder="Insert some text" type="text">{!! $price->benefits_traditional !!}</textarea>
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="backend-form-field">
                                                                                        ...
                                                                                        <textarea data-backend-richtext="true" name="benefits_simplified" id="benefits_simplified" class="textarea_editor backend-form-control @error('benefits_simplified') is-invalid @enderror" placeholder="Insert some text" type="text">{!! $price->benefits_simplified !!}</textarea>
            ...
            @canany(['posDev','posAuthor'])
                <div class="card-box-footer">
                    <a href="{{ route('view.add-villa-price',$villa->id) }}" data-toggle="tooltip" data-placement="top" title="Add Normal Price">
                        <button type="button" class="backend-button backend-button-primary btn-sm"><i class="icon-copy fa fa-plus" aria-hidden="true"></i> Add Price</button>
                    </a>
                </div>
            @endcanany
        </div>
