    ...
    @if (count($lunchVenues)>0)
        <div class="card-box-content m-b-8">
            @foreach ($lunchVenues as $lunch_venue)
                <div class="card">
                    <a href="#" data-toggle="modal" data-target="#detail-lunch-venue-{{ $lunch_venue->id }}">
                        ...
                        <div class="modal-content">
                            <div class="card-box">
                                ...
                                <div class="card-box-footer">
                                    ...
                                    @else
                                        <button type="submit" form="deactivate-lunch-venue-{{ $lunch_venue->id }}" class="backend-button backend-button-secondary"><i class="icon-copy fa fa-pencil-alt" aria-hidden="true"></i> Save as Draft</button>
                                    @endif
