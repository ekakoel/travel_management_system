                                    ...
                                    @if ($promo_benefits || $promo_include || $promo_additional_info)
                                        <section>
                                            <div class="frontend-detail-block__header">
                                                <div>
                                                    <div class="frontend-detail-block__eyebrow">@lang('messages.Promotion Details')</div>
                                                    <h3 class="frontend-detail-block__title">@lang('messages.Benefits, inclusions, and booking notes')</h3>
                                                </div>
                                            </div>
