                            ...
                            <div class="col-md-8 m-b-18">
                                <div class="card-box p-b-18">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-6 col-md-6">
                                                <div class="backend-form-field">
                                                    ...
                                                    <select name="wedding_venue_id" id="wedding_venue_id" class="backend-form-control @error('wedding_venue_id') is-invalid @enderror" required>
                                            ...
                                            <div class="col-6 col-md-3">
                                                <div class="backend-form-field">
                                                    ...
                                                    <input type="number" min="1" id="duration_day" name="duration_day" class="backend-form-control @error('duration_day') is-invalid @enderror" placeholder="Day" value="{{ old('duration_day') }}" required>
                                                    @error('duration_day')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-6 col-md-3">
                                                <div class="backend-form-field">
                                                    ...
                                                    <input type="number" min="0" id="duration_night" name="duration_night" class="backend-form-control @error('duration_night') is-invalid @enderror" placeholder="Night" value="{{ old('duration_night') }}" required>
                                            ...
                                            <div class="col-12 col-sm-12 col-md-12">
                                                <div class="backend-form-field">
                                                    ...
                                                    <textarea data-backend-richtext="true" id="description" name="description" class="textarea_editor backend-form-control @error('Description') is-invalid @enderror" placeholder="Insert description" value="{{ old('description') }}"></textarea>
                                                    @error('description')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-12 col-sm-12 col-md-12">
                                                <div class="backend-form-field">
                                                    ...
                                                    <textarea data-backend-richtext="true" id="additional_info" name="additional_info" class="textarea_editor backend-form-control @error('additional_info') is-invalid @enderror" placeholder="Insert additional_info" value="{{ old('additional_info') }}"></textarea>
                                            ...
                                            <div class="col-12 col-sm-12 col-md-12">
                                                <div class="backend-form-field">
                                                    ...
                                                    <textarea data-backend-richtext="true" id="remark" name="remark" class="textarea_editor backend-form-control @error('Description') is-invalid @enderror" placeholder="Insert Remark" value="{{ old('remark') }}"></textarea>
                                                    @error('remark')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                    ...
                                    <div class="card-box-footer">
                                        <button type="submit" form="addWeddingDinnerVenue" class="backend-button backend-button-primary"><i class="icon-copy fa fa-check" aria-hidden="true"></i> Create Wedding</button>
