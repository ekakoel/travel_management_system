...
@section('content')
    @canany(['posDev', 'posAuthor'])
        @php
            ...
            $hasLegacyItinerary =
                trim(strip_tags((string) $tour->itinerary)) !== '' ||
            ...
            $nameTranslationGroup = [
                ...
                'fields' => [
                    ...
                    [
                        ...
                        'placeholder' => 'Insert traditional tour package name',
                    ],
                    [
                        'name' => 'name_simplified',
                        'label' => 'Simplified Chinese',
                        'placeholder' => 'Insert simplified tour package name',
                    ],
                ],
            ];
            ...
            $contentTranslationGroups = [
                [
                    ...
                    'fields' => [
                        ...
                        [
                            'name' => 'short_description_traditional',
                            'label' => 'Traditional Chinese',
                            'placeholder' => 'Insert traditional short description',
                        ],
                        [
                            'name' => 'short_description_simplified',
                            'label' => 'Simplified Chinese',
                            'placeholder' => 'Insert simplified short description',
                        ],
                    ],
                ],
                [
                    ...
                    'fields' => [
                        ...
                        [
                            ...
                            'label' => 'Traditional Chinese',
                            'placeholder' => 'Insert traditional description',
                        ],
                        [
                            'name' => 'description_simplified',
                            'label' => 'Simplified Chinese',
                            'placeholder' => 'Insert simplified description',
                        ],
                    ],
                ],
                [
                    ...
                    'fields' => [
                        [
                            ...
                            'label' => 'English',
                            'placeholder' => 'Insert package highlights',
                        ],
                        [
                            'name' => 'package_highlights_traditional',
                            'label' => 'Traditional Chinese',
                            'placeholder' => 'Insert traditional package highlights',
                        ],
                        [
                            'name' => 'package_highlights_simplified',
                            'label' => 'Simplified Chinese',
                            'placeholder' => 'Insert simplified package highlights',
                        ],
                    ],
                ],
                [
                    ...
                    'fields' => [
                        ...
                        [
                            'name' => 'include_traditional',
                            'label' => 'Traditional Chinese',
                            'placeholder' => 'Insert traditional inclusions',
                        ],
                        [
                            'name' => 'include_simplified',
                            'label' => 'Simplified Chinese',
                            'placeholder' => 'Insert simplified inclusions',
                        ],
                    ],
                ],
                [
                    ...
                    'fields' => [
                        ...
                        [
                            'name' => 'exclude_traditional',
                            'label' => 'Traditional Chinese',
                            'placeholder' => 'Insert traditional exclusions',
                        ],
                        [
                            'name' => 'exclude_simplified',
                            'label' => 'Simplified Chinese',
                            'placeholder' => 'Insert simplified exclusions',
                        ],
                    ],
                ],
                [
                    ...
                    'fields' => [
                        ...
                        [
                            'name' => 'additional_info_traditional',
                            'label' => 'Traditional Chinese',
                            'placeholder' => 'Insert traditional additional information',
                        ],
                        [
                            'name' => 'additional_info_simplified',
                            'label' => 'Simplified Chinese',
                            'placeholder' => 'Insert simplified additional information',
                        ],
                    ],
                ],
                [
                    ...
                    'fields' => [
                        [
                            ...
                            'label' => 'English',
                            'placeholder' => 'Insert cancellation policy',
                        ],
                        [
                            'name' => 'cancellation_policy_traditional',
                            'label' => 'Traditional Chinese',
                            'placeholder' => 'Insert traditional cancellation policy',
                        ],
                        [
                            'name' => 'cancellation_policy_simplified',
                            'label' => 'Simplified Chinese',
                            'placeholder' => 'Insert simplified cancellation policy',
                        ],
                    ],
                ],
            ];
        ...
        <main class="main-container tour-form-page tour-form-page--edit">
            <div class="pd-ltr-20">
                <x-backend.page-hero class="tour-form-hero" eyebrow="Tour Package" title="Edit Tour Package"
                ...
                <x-backend.breadcrumb-toolbar class="tour-form-toolbar" :items="[
                ...
                <form id="tourEditForm" class="backend-form" action="{{ route('admin.tours.update', $tour->id) }}"
                    ...
                    <x-backend.detail-layout class="tour-create-layout tour-edit-layout">
                            ...
                            <div class="tour-create-wizard" data-tour-create-wizard data-error-step="{{ $errorStep }}">
                                <nav class="tour-create-wizard__steps" aria-label="Edit Tour steps">
                                    @foreach ($wizardSteps as $key => $label)
                                        <button type="button" class="tour-create-wizard__step"
                                            data-tour-wizard-step="{{ $key }}" data-step-title="{{ $label }}">
                                ...
                                <section class="backend-panel tour-form-panel backend-form-panel tour-create-wizard__panel"
                                    data-tour-wizard-panel="basic">
                                    ...
                                    <div class="backend-form-panel__body tour-form-panel__body">
                                        <section class="backend-translation-group" data-backend-translation-group>
                                            <div class="backend-translation-group__header">
                                                <h3 class="backend-translation-group__title">
                                                    {{ $nameTranslationGroup['title'] }}</h3>
                                                <p class="backend-translation-group__description">
                                                    {{ $nameTranslationGroup['description'] }}</p>
                                            </div>
                                                ...
                                                @foreach ($nameTranslationGroup['fields'] as $field)
                                                    <div class="backend-form-field">
                                                        <label for="{{ $field['name'] }}"
                                                            class="backend-form-label">{{ $field['label'] }}
                                                            <span>*</span></label>
                                                        <input type="text" id="{{ $field['name'] }}"
                                                            name="{{ $field['name'] }}"
                                                            class="backend-form-control @error($field['name']) is-invalid @enderror"
                                            ...
                                            <div class="backend-form-grid">
                                                <div class="backend-form-field">
                                                    <label for="code" class="backend-form-label">Tour Code
                                                        <span>*</span></label>
                                                    <input type="text" id="code" name="code"
                                                        class="backend-form-control @error('code') is-invalid @enderror"
                                                        placeholder="Insert tour code" value="{{ old('code', $tour->code) }}"
                                                        required>
                                                    @error('code')
                                                        <span class="invalid-feedback d-block">{{ $message }}</span>
                                                    @enderror
                                                ...
                                                <div class="backend-form-field">
                                                    ...
                                                    <select id="type" name="type"
                                                        class="backend-form-control @error('type') is-invalid @enderror"
                                                        required>
                                                        <option value="">Select Type</option>
                                                        @foreach ($types as $type)
                                                            <option value="{{ $type->id }}" @selected((string) old('type', $tour->type_id) === (string) $type->id)>
                                                                {{ $type->type }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('type')
                                                ...
                                                <div class="backend-form-field">
                                                    <label for="duration_days" class="backend-form-label">Duration Days
                                                        <span>*</span></label>
                                                    <select id="duration_days" name="duration_days"
                                                        class="backend-form-control @error('duration_days') is-invalid @enderror"
                                                        required>
                                                        @foreach (range(1, 7) as $day)
                                                            <option value="{{ $day }}" @selected((string) old('duration_days', $tour->duration_days) === (string) $day)>
                                                                {{ $day }}D</option>
                                                        @endforeach
                                                    </select>
                                                    @error('duration_days')
                                                ...
                                                <div class="backend-form-field">
                                                    <label for="duration_nights" class="backend-form-label">Duration Nights
                                                        <span>*</span></label>
                                                    <select id="duration_nights" name="duration_nights"
                                                        class="backend-form-control @error('duration_nights') is-invalid @enderror"
                                                        required>
                                                        @foreach (range(0, 7) as $night)
                                                            <option value="{{ $night }}" @selected((string) old('duration_nights', $tour->duration_nights) === (string) $night)>
                                                                {{ $night > 0 ? $night . 'N' : '-' }}</option>
                                                        @endforeach
                                                    </select>
                                ...
                                <section class="backend-panel tour-form-panel backend-form-panel tour-create-wizard__panel"
                                    data-tour-wizard-panel="route">
                                    <div class="backend-section-header tour-form-panel__heading">
                                        <div>
                                            <span class="backend-section-header__label">Step 2</span>
                                            <h2>Route & Itinerary</h2>
                                        </div>
                                        <p>Structured stops are the authoritative route and generated itinerary source for Tours
                                            that have route locations.</p>
                                    </div>
                                    ...
                                    <div class="backend-form-panel__body tour-form-panel__body">
                                        @if ($usesLegacyItinerary)
                                            <div class="backend-alert backend-alert--warning">
                                                ...
                                                <span>Add Route & Itinerary stops to migrate it to the structured itinerary
                                                    system. Saving other fields will preserve the legacy itinerary
                                                    columns.</span>
                                            </div>
                                        @endif

                                        @include(
                                            'backend.operations.tours.partials.tour-location-repeater',
                                            [
                                                'tour' => $tour,
                                ...
                                <section class="backend-panel tour-form-panel backend-form-panel tour-create-wizard__panel"
                                    data-tour-wizard-panel="content">
                                    <div class="backend-section-header tour-form-panel__heading">
                                        <div>
                                            <span class="backend-section-header__label">Step 3</span>
                                            <h2>Content & Translations</h2>
                                        </div>
                                        <p>Customer-facing copy grouped by English, Traditional Chinese, and Simplified Chinese.
                                            Manual itinerary editors are intentionally not part of this step.</p>
                                    </div>
                                                    ...
                                                    @foreach ($group['fields'] as $field)
                                                        <div class="backend-form-field">
                                                            ...
                                                            <textarea id="{{ $field['name'] }}" name="{{ $field['name'] }}"
                                                                class="textarea_editor backend-form-control @error($field['name']) is-invalid @enderror"
                                                                data-backend-richtext="true" placeholder="{{ $field['placeholder'] }}"
                                                                @if ($group['required']) required @endif>{{ old($field['name'], $tour->{$field['name']}) }}</textarea>
                                                            @error($field['name'])
                                                                <span class="invalid-feedback d-block">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                ...
                                                <div class="tour-form-cover-control">
                                                    ...
                                                    <div class="tour-form-cover-input">
                                                        <input type="file" name="cover" id="cover"
                                                            class="backend-form-control @error('cover') is-invalid @enderror"
                                                            accept="image/jpeg,image/png,image/jpg,image/webp"
                                                            data-tour-cover-input
                                                            data-tour-cover-preview-target="[data-tour-cover-preview]"
                                                            data-tour-cover-existing="{{ $currentCoverLabel }}">
                                                        <span class="tour-file-status" data-tour-cover-status
                                                            data-tour-cover-status-default="{{ $currentCoverLabel }}">{{ $currentCoverLabel }}</span>
                                                        <small class="form-text text-muted">Leave empty to preserve the current
                                                            cover.</small>
                                                        @error('cover')
                                                            <span class="invalid-feedback d-block">{{ $message }}</span>
                                                        @enderror
                                        ...
                                        <div class="tour-create-review-layout">
                                            <section class="tour-create-review-block tour-create-review-block--wide">
                                                ...
                                                <dl class="tour-create-review-list">
                                                    ...
                                                    <div>
                                                        <dt>Type</dt>
                                                        <dd data-tour-summary-type>{{ $tour->type?->type ?: 'Not selected' }}
                                                        </dd>
                                                    </div>
                                                    <div>
                                                        <dt>Duration</dt>
                                                        <dd data-tour-summary-duration>{{ (int) $tour->duration_days }}D /
                                                            {{ (int) $tour->duration_nights }}N</dd>
                                                    </div>
                                                    <div>
                                                        <dt>Status</dt>
                                                ...
                                                <div class="tour-create-review-language-grid">
                                                    <div>
                                                        <span>English</span>
                                                        <strong
                                                            data-tour-review-name-en>{{ $tour->name ?: 'Not filled' }}</strong>
                                                    </div>
                                                    <div>
                                                        <span>Traditional Chinese</span>
                                                        <strong
                                                            data-tour-review-name-traditional>{{ $tour->name_traditional ?: 'Not filled' }}</strong>
                                                    </div>
                                                    <div>
                                                        <span>Simplified Chinese</span>
                                                        <strong
                                                            data-tour-review-name-simplified>{{ $tour->name_simplified ?: 'Not filled' }}</strong>
                                                    </div>
                                                </div>
                                            </section>
                                            ...
                                            <section class="tour-create-review-block">
                                                <div class="tour-create-review-block__header">
                                                    ...
                                                    <strong data-tour-summary-route>{{ $routeDays }} day(s),
                                                        {{ $routeStops }} stop(s)</strong>
                                                </div>
                                                <div class="tour-create-review-route" data-tour-review-route-days>
                                                    <p>{{ $routeStops ? 'Route stops loaded.' : 'No route stops added yet.' }}
                                                    </p>
                                                </div>
                                            </section>
                                            ...
                                            <section class="tour-create-review-block">
                                                <div class="tour-create-review-block__header">
                                                    ...
                                                    <strong data-tour-review-content-summary>0 of 9 required fields
                                                        filled</strong>
                                                </div>
                                ...
                                <section
                                    class="backend-page-toolbar backend-form-actions tour-form-actions tour-create-wizard__actions">
                                    <div>
                                        <span class="tour-create-wizard__current">Current step: <strong
                                                data-tour-wizard-current-label>Basic Information</strong></span>
                                    </div>
                                    <div class="backend-page-toolbar__actions">
                                        <a href="{{ route('admin.tours.show', $tour->id) }}"
                                            class="backend-button backend-button-secondary">Cancel</a>
                                        <button type="button" class="backend-button backend-button-secondary"
                                            data-tour-wizard-back>Back</button>
                                        <button type="button" class="backend-button backend-button-primary"
                        ...
                        <x-slot name="side">
                            <section
                                class="backend-panel backend-detail-side-card tour-create-context-panel tour-status-side-card">
                                <div class="backend-section-header">
                                    <div>
                                        <span class="backend-section-header__label">Current Status</span>
                                        <h2><span
                                                class="backend-status-badge backend-status-badge--{{ $statusTone }}">{{ $statusLabel }}</span>
                                        </h2>
                                    </div>
                                ...
                                <div class="backend-detail-side-card__body">
                                    <div class="backend-form-field">
                                        ...
                                        <select id="status" name="status"
                                            class="backend-form-control @error('status') is-invalid @enderror" required>
                            ...
                            <section class="backend-panel backend-detail-side-card tour-create-context-panel">
                                ...
                                <div class="backend-detail-side-card__body">
                                    <ul class="backend-detail-side-list">
                                        <li><span>Basic Information</span><strong
                                                data-tour-summary-name>{{ $tour->name ?: 'Not filled' }}</strong></li>
                                        <li><span>Route & Itinerary</span><strong data-tour-summary-route>{{ $routeDays }}
                                                day(s), {{ $routeStops }} stop(s)</strong></li>
                                        <li><span>Content & Translations</span><strong data-tour-review-content-summary>0 of 9
                                                required fields filled</strong></li>
                                        <li><span>Media</span><strong data-tour-summary-cover>{{ $currentCoverLabel }}</strong>
                                        </li>
                                    </ul>
                                </div>
                            </section>
                            ...
                            <section class="backend-panel backend-detail-side-card tour-create-context-panel">
                                <div class="backend-section-header">
                                    ...
                                    <p>{{ $usesLegacyItinerary ? 'Legacy manual itinerary is preserved until structured route stops are added.' : 'Structured locations drive the generated itinerary when available.' }}
                                    </p>
                                </div>
                                <div class="backend-detail-side-card__body">
                                    <dl class="backend-detail-side-list">
                            ...
                            <section class="backend-panel backend-detail-side-card tour-create-context-panel">
                                ...
                                <div class="backend-detail-side-actions">
                                    <a href="{{ route('admin.tours.show', $tour->id) }}"
                                        class="backend-button backend-button-secondary">View Tour</a>
                                    <a href="{{ route('admin.tours.show', $tour->id) }}#prices"
                                        class="backend-button backend-button-secondary">Manage Tour Price</a>
                                    <a href="{{ route('admin.tour-packages.index') }}"
                                        class="backend-button backend-button-secondary">Back to Tours</a>
                                </div>
                            </section>
                        </x-slot>
