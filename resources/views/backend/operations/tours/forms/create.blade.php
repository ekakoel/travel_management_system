...
@section('content')
    @canany(['posDev', 'posAuthor'])
        ...
        <main class="main-container tour-form-page tour-form-page--create">
            <div class="pd-ltr-20">
                <x-backend.page-hero class="tour-form-hero" eyebrow="Tour Package" title="Add Tour Package"
                ...
                <form id="tourCreateForm" class="backend-form" action="{{ route('admin.tours.store') }}" method="post"
                            ...
                            <div class="tour-create-wizard" data-tour-create-wizard data-error-step="{{ $errorStep }}">
                                            ...
                                            <div class="backend-form-grid">
                                                <div class="backend-form-field">
                                                    ...
                                                    <input type="text" id="code" name="code"
                                                        ...
                                                        placeholder="Insert tour code" value="{{ old('code') }}" required>
                                                    @error('code')
                                                        <span class="invalid-feedback d-block">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="backend-form-field">
                                                    ...
                                                    <select id="type" name="type"
                                                        ...
                                                        @foreach ($types as $type)
                                                            <option value="{{ $type->id }}" @selected((string) old('type') === (string) $type->id)>
                                                                {{ $type->type }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('type')
                                                ...
                                                <div class="backend-form-field">
                                                    ...
                                                    <select id="duration_days" name="duration_days"
                                                        ...
                                                        @foreach (range(1, 7) as $day)
                                                            <option value="{{ $day }}" @selected((string) old('duration_days', 1) === (string) $day)>
                                                                {{ $day }}D</option>
                                                        @endforeach
                                                    </select>
                                                    @error('duration_days')
                                                ...
                                                <div class="backend-form-field">
                                                    ...
                                                    <select id="duration_nights" name="duration_nights"
                                                        ...
                                                        @foreach (range(0, 7) as $night)
                                                            <option value="{{ $night }}" @selected((string) old('duration_nights', 0) === (string) $night)>
                                ...
                                <section class="backend-panel tour-form-panel backend-form-panel tour-create-wizard__panel"
                                    ...
                                    <div class="backend-section-header tour-form-panel__heading">
                                        ...
                                        <p>Optional structured stops used as the source for the public route map and generated
                                            itinerary.</p>
                                    </div>
                                                    ...
                                                    @foreach ($group['fields'] as $field)
                                                        <div class="backend-form-field">
                                                            ...
                                                            <textarea id="{{ $field['name'] }}" name="{{ $field['name'] }}"
                                                                ...
                                                                @if ($group['required']) required @endif>{{ old($field['name']) }}</textarea>
                                                            @error($field['name'])
                                                                <span class="invalid-feedback d-block">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                ...
                                <section class="backend-panel tour-form-panel backend-form-panel tour-create-wizard__panel"
                                    ...
                                    <div class="backend-section-header tour-form-panel__heading">
                                        ...
                                        <p>Upload the primary image used for backend inventory and public Tour Package listing.
                                        </p>
                                    </div>
                                    ...
                                    <div class="backend-form-panel__body tour-form-panel__body">
                                        <div class="backend-form-grid">
                                            <div class="backend-form-field is-wide">
                                                <label for="cover" class="backend-form-label">Cover Image
                                                    <span>*</span></label>
                                                <div class="tour-form-cover-control">
                                                    ...
                                                    <div class="tour-form-cover-input">
                                                        ...
                                                        <span class="tour-file-status" data-tour-cover-status
                                                            data-tour-cover-status-default="No cover selected">No cover
                                                            selected</span>
                                                        <small class="form-text text-muted">This cover image is used as the
                                                            primary Tour visual.</small>
                                                        @error('cover')
                                                            <span class="invalid-feedback d-block">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                ...
                                <section
                                    ...
                                    <div class="backend-page-toolbar__actions">
                                        ...
                                        <button type="submit" class="backend-button backend-button-primary"
                                            data-tour-wizard-submit hidden>
