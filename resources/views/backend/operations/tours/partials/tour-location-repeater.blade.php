                ...
                <div class="tour-location-item @if($compactLocationCards && ! $hasLocationError) is-collapsed @endif" data-tour-location-item>
                    ...
                    <div class="row tour-location-editor" data-tour-location-editor>
                        <div class="backend-form-panel__body">
                            ...
                            <div class="backend-form-grid-2 d-none" data-tour-manual-coordinate-field>
                                <div class="backend-form-field">
        ...
        <template data-tour-location-template>
            <div class="tour-location-item" data-tour-location-item>
                ...
                <div class="row tour-location-editor" data-tour-location-editor>
                    <div class="backend-form-panel__body">
                        <div class="backend-form-grid-1">
                            <div class="backend-form-field"><label>Marker Cover Image</label><input type="hidden"
                                    data-field-name="existing_marker_image">
                                <div class="tour-location-marker-control">
                                    <div class="tour-location-marker-control__preview" data-tour-location-image-preview>
                                        <span>No marker cover selected</span></div>
                                    <div class="tour-location-marker-control__input"><input type="file"
                                            data-field-name="marker_image" class="backend-form-control"
                                            accept="image/jpeg,image/png,image/jpg,image/webp"><small
                                            class="form-text text-muted">Optional. If empty, marker will use this tour
                                            package cover image.</small></div>
                                </div>
                            </div>
                        </div>
                        <div class="backend-form-grid">
                            <div class="backend-form-field">
                                <label>Destination Name</label>
                                <input type="hidden" data-field-name="location_reference_id" data-tour-location-reference-id>
                                    <div class="tour-location-suggest">
                                        <input type="text" data-field-name="destination_name" data-tour-location-name class="backend-form-control" placeholder="e.g. Tanah Lot Temple" autocomplete="off">
                                    <div class="tour-location-suggest__menu" data-tour-location-suggestions></div>
                                </div>
                            </div>
                            <div class="backend-form-field">
                                <label>Order</label>
                                <input type="number" min="1" value="1" data-field-name="visit_order" class="backend-form-control">
                            </div>
                        </div>
                        <div class="backend-form-grid">
                            <div class="backend-form-field">
                                <label>Location Type</label>
                                <select data-field-name="location_type" class="backend-form-control">
                                    <option value="Attraction">Attraction</option>
                                    <option value="Activity">Activity</option>
                                    <option value="F&B">F&amp;B</option>
                                    <option value="Pickup/Dropoff">Pickup/Dropoff Location</option>
                                </select>
                            </div>
                            <div class="backend-form-field">
                                <label>Day</label>
                                <input type="number" min="1" value="1" data-field-name="day_number" class="backend-form-control">
                            </div>
                            <div class="backend-form-field">
                                <label>Visit Time</label>
                                <input type="time" data-field-name="visit_time" class="backend-form-control">
                            </div>
                        </div>
                        <div class="backend-form-grid-2 d-none" data-tour-manual-coordinate-field>
                            <div class="backend-form-field">
                                <label>Latitude</label>
                                <input type="number" step="0.0000001" min="-90" max="90" data-field-name="latitude" data-tour-location-latitude class="backend-form-control" placeholder="Auto from Google link or -8.6212130">
                            </div>
                            <div class="backend-form-field">
                                <label>Longitude</label>
                                <input type="number" step="0.0000001" min="-180" max="180" data-field-name="longitude" data-tour-location-longitude class="backend-form-control" placeholder="Auto from Google link or 115.0868060">
                            </div>
                        </div>
                        <div class="backend-form-grid-1">
                            <div class="backend-form-field">
                                <label>Google Maps Short Link / Coordinate URL</label>
                                <input type="url" data-field-name="google_maps_url" data-tour-location-map-url class="backend-form-control" placeholder="https://maps.app.goo.gl/...">
                                <small class="form-text text-muted" data-tour-coordinate-status>Coordinates will be filled from selected reference or by resolving a Google Maps URL.</small>
                            </div>
                        </div>
                        <div class="backend-form-grid">
                            <div class="backend-form-field"><label
                                    class="backend-form-label">English</label>
                                <textarea data-field-name="description" class="backend-form-control" data-backend-richtext="true" rows="2"
                                    placeholder="Short stop note for marker popup"></textarea>
                            </div>
                            <div class="backend-form-field"><label class="backend-form-label">Traditional
                                    Chinese</label>
                                <textarea data-field-name="description_traditional" class="backend-form-control" data-backend-richtext="true"
                                    rows="2" placeholder="Insert traditional destination description"></textarea>
                            </div>
                            <div class="backend-form-field"><label class="backend-form-label">Simplified
                                    Chinese</label>
                                <textarea data-field-name="description_simplified" class="backend-form-control" data-backend-richtext="true"
                                    rows="2" placeholder="Insert simplified destination description"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
