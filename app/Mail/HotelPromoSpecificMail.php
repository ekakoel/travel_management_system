...
class HotelPromoSpecificMail extends Mailable
{
    ...
    public function __construct(string $bookingcode, string $user, Hotels $hotel, HotelPromo $promo, string $link, string $title, string $title_mandarin, string $suggestion, string $suggestion_mandarin,)
    {
