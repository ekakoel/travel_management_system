...
class TransportOrderLifecycleService
{
    ...
    public function applyTransportCurrentScope(Builder $query, Carbon $now): Builder
    {
        return $query
    ...
    public function applyTransportHistoryScope(Builder $query, Carbon $now): Builder
    {
        return $query
            ->where('service', Orders::PUBLIC_TRANSPORT_SERVICE)
